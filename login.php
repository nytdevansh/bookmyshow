...
<head>
  ...
  <title>Sign In — BookMyShow</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .cinema-panel .dots span:first-child { background: var(--red); width: 22px; border-radius: 4px; }
...
<body>
  ...
  <div class="main-wrap">
    ...
    <div class="cinema-panel">
      <div class="cp-inner">
        <h1>Welcome to<br/><span>BookMyShow</span></h1>
        <p>Your ultimate destination for movies, events, and unforgettable experiences &mdash; all in one place.</p>
